...
def py2_test():
    ...
    assert py2_filter(_coconut.functools.partial(_coconut.operator.__gt__, 3), range(10)) == [0, 1, 2]
    assert py2_map(_coconut.functools.partial(_coconut.operator.__add__, 2), range(5)) == [2, 3, 4, 5, 6]
